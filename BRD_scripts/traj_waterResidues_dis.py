...
ofile1.write( 'frame'.ljust(8) + ' pdY_O-wPf_O pdY_O-pMd_O pdY_O-V1_O N1_ND2-V1_O pMd_N-V1_O preP_O-V1_O pMd_N-wPf_O V1_O-wPf_O'+ '\n' );
...
for ts in univ.trajectory:
    ...
    ofile1.write( '  ' + '%8.2f' %lg.norm(mark6.position-mark1.position)+ '\n' );
ofile1.close();
